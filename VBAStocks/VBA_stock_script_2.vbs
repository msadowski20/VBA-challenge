...
'Set sheet variables
Set data2016 = ThisWorkbook.Sheets("2016")
Set data2015 = ThisWorkbook.Sheets("2015")
Set data2014 = ThisWorkbook.Sheets("2014")

'Set last row variables
Let lastrow2016 = data2016.Range("A1").End(xlDown).Row
